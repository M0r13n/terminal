...
class Badge {
    ...
    add_svgs() {
        ...
        const containerElement = document.getElementById(Badge.CONTAINER_ID);
        containerElement.appendChild(this.active_svg);
        containerElement.appendChild(this.inactive_svg);
    }
